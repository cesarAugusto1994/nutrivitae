...
<div id="wrapper">
    ...
    <div id="right-sidebar" class="animated">
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="sidebar-container" style="overflow: hidden; width: auto; height: 100%;">
            ...
            </div><div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 42.0844px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.4; z-index: 90; right: 1px;"></div></div>
...
<script src="{{asset('admin/js/custom3.min.js')}}"></script>
<script src="{{asset('admin/js/custom.min.js')}}"></script>
<script src="{{asset('admin/js/custom2.min.js')}}"></script>
<script src="{{asset('admin/js/custom4.min.js')}}"></script>
<script src="{{asset('admin/js/custom5.min.js')}}"></script>
<script src="{{asset('admin/js/custom6.min.js')}}"></script>
<script src="{{asset('admin/js/custom7.min.js')}}"></script>
<script src="{{asset('admin/js/plugins/metisMenu/jquery.metisMenu.js')}}"></script>
